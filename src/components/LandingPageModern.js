...
const LandingPageModern = ({ user, onShowPGDetail, onShowUserProfile }) => {
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="container mx-auto px-4 py-8 md:py-12">
        <div className="text-center mb-8 md:mb-12">
          ...
          <div className="flex justify-center gap-8 md:gap-12 mb-8">
            <div className="text-center">
              <h3 className="text-2xl font-bold">{samplePGData.length}+</h3>
        ...
        <div className="grid grid-cols-4 md:grid-cols-4 lg:grid-cols-8 gap-2 md:gap-3 mb-12">
          {samplePGData.slice(0, 8).map((pg, idx) => (
            <div 
              key={idx} 
              className="group relative overflow-hidden rounded-lg aspect-square cursor-pointer shadow-sm hover:shadow-lg transition-all duration-300"
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <div className="space-y-6">
          {samplePGData.slice(0, 3).map((pg) => (
            <div 
              key={pg.id} 
              className="group cursor-pointer flex gap-4 p-4 rounded-xl hover:bg-gray-50 transition-all"
              onClick={() => handlePGClick(pg)}
            >
              ...
              <div className="flex-1">
                <h4 className="font-semibold text-lg mb-1 group-hover:text-orange-600 transition-colors">{pg.name}</h4>
                <p className="text-sm text-gray-600 mb-1 flex items-center gap-1">
                  <MapPin className="w-3 h-3" /> {pg.distanceFromCollege}
                </p>
                <div className="flex items-center justify-between">
                  <p className="font-semibold text-lg">₹{pg.rent}/mo</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="flex gap-6 mb-4">
                <div>
                  <p className="text-2xl font-bold">{samplePGData.length}+</p>
      ...
      <section className="bg-black text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center mb-8">
            ...
            <div className="text-center">
              <p className="text-3xl font-bold">{samplePGData.length}+</p>
